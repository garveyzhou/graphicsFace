...
dsiplay.o: display.c display.h ml6.h matrix.h gmath.h
	$(CC) $(CFLAGS) -c display.c

matrix.o: matrix.c matrix.h gmath.h
	$(CC) $(CFLAGS) -c matrix.c

parser.o: parser.c parser.h matrix.h draw.h display.h ml6.h gmath.h
